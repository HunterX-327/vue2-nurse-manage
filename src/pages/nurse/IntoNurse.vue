<template>
    <el-card style="height:100%;box-sizing: border-box;">
        <el-container>
            <!-- 头部部分 -->
            <el-header>
                <HeaderVue pageName="IntoNurse" :formData="formData">
                </HeaderVue>
            </el-header>
            ...
            <el-main>
                <MainVue :tableData="tableData">
                    ...
                    <el-table-column label="操作" align="center" fixed="right" width="300">
                        <el-button type="text" icon="el-icon-user" size="mini" style="color:orange">接受看护</el-button>
            ...
            <el-footer>
                <FooterVue :totalSize="totalSize" :tableData="tableData" @changePage="changePage"
                    @changeSize="changeSize"></FooterVue>
            </el-footer>
        </el-container>
    </el-card>
</template>
